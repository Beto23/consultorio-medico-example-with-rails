...
class ConsultationsControllerTest < ActionController::TestCase
  ...
  test "should create consultation" do
    assert_difference('Consultation.count') do
      post :create, consultation: { fecha: @consultation.fecha, medic_id: @consultation.medic_id, patient_id: @consultation.patient_id, time: @consultation.time }
    end
  ...
  test "should update consultation" do
    patch :update, id: @consultation, consultation: { fecha: @consultation.fecha, medic_id: @consultation.medic_id, patient_id: @consultation.patient_id, time: @consultation.time }
    assert_redirected_to consultation_path(assigns(:consultation))
  end
